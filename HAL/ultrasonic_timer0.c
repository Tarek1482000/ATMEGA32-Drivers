...
void UltrasonicTimer0_init(void)
{
	...
	Timer0_Ovf_Start();
	Timer0_setCallBack(UltrasonicTimer0_edgeProcessing);/* To count the time that taken to send and receive signal  */


	INT0_init();
	INT0_setCallBack(UltrasonicTimer0_detectedge);/* To detect ECHO signal */
