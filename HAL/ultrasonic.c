...
#include "../MCAL/icu.h" /* To use call back function and calculate edge */
#include "../MCAL/gpio.h"
...
Icu_ConfigType Config_Ptr={F_CPU_8_ICU,RISING}; /* Configre Icu */
